  ...
  return {
    ...
    HeaderAccount: ({
      ...
      <div data-testid="header-account">
        ...
        {enableAssistanceButton && (
          <button onClick={onAssistanceClick} data-testid="assistance-btn">
            Assistance
          </button>
        )}
        {onDocumentationClick && (
          <button onClick={onDocumentationClick} data-testid="documentation-btn">
            Documentation
          </button>
        )}
    ...
    HeaderProduct: ({
      ...
      <div data-testid="header-product">
        ...
        {onSelectedProduct && (
          <button
            onClick={() => onSelectedProduct({ id: 'test-product' })}
        ...
        {onSelectedParty && (
          <button
            onClick={() => onSelectedParty({ id: 'test-party' })}
...
describe('CustomHeader', () => {
  ...
  describe('User Dropdown and Actions', () => {
    ...
    it('should render user actions when userActions are provided', () => {
      const mockUserActions = [
        { id: '1', label: 'Action 1', icon: 'settings', onClick: jest.fn() },
        { id: '2', label: 'Action 2', icon: 'logout', onClick: jest.fn() },
      ];
  ...
  describe('HeaderProduct with Products and Parties', () => {
    it('should pass selected product id to HeaderProduct', () => {
      render(<CustomHeader {...defaultProps} withSecondHeader={true} selectedProductId="prod-1" />);
    ...
    it('should pass selected party id to HeaderProduct', () => {
      render(<CustomHeader {...defaultProps} withSecondHeader={true} selectedPartyId="party-1" />);
    ...
    it('should pass party list to HeaderProduct', () => {
      render(<CustomHeader {...defaultProps} withSecondHeader={true} partyList={mockPartyList} />);
  ...
  describe('Default Props', () => {
    ...
    it('should add selfcare product by default', () => {
      render(
        <CustomHeader {...defaultProps} withSecondHeader={true} productsList={mockProductsList} />
      );
      expect(screen.getByTestId('products-count')).toHaveTextContent('3');
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle empty partyList', () => {
      render(<CustomHeader {...defaultProps} withSecondHeader={true} partyList={[]} />);
      expect(screen.getByTestId('parties-count')).toHaveTextContent('0');
    });
