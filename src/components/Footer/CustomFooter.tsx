...
const FOOTER_LINKS = {
    ...
    PRIVACY: 'https://eie.cstar.pagopa.it/elenco-informatico-elettrodomestici/privacy-policy',
    ...
    TERMS_AND_CONDITIONS: 'https://eie.cstar.pagopa.it/elenco-informatico-elettrodomestici/terms-of-service',
