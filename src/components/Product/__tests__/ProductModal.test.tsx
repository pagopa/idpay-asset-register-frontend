...
const mockSetSupervisionedStatusList = setSupervisionedStatusList as jest.MockedFunction<
  typeof setSupervisionedStatusList
>;
const mockSetRejectedStatusList = setRejectedStatusList as jest.MockedFunction<
  typeof setRejectedStatusList
>;
...
describe('ProductModal', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render dialog when open is true', () => {
      render(<ProductModal status={''} {...defaultProps} actionType="supervised" />);
    ...
    it('should not render dialog when open is false', () => {
      render(<ProductModal status={''} {...defaultProps} open={false} actionType="supervised" />);
  ...
  describe('ActionType: supervised', () => {
    it('should render supervised modal content', () => {
      render(<ProductModal status={''} {...defaultProps} actionType="supervised" />);
    ...
    it('should have supervised button disabled when motivation is empty', () => {
      render(<ProductModal status={''} {...defaultProps} actionType="supervised" />);
    ...
    it('should enable supervised button when motivation is provided', async () => {
    ...
    it('should call setSupervisionedStatusList when supervised button is clicked', async () => {
      const user = userEvent.setup();
      // @ts-ignore
    ...
    it('should handle supervised API error', async () => {
      const user = userEvent.setup();
  ...
  describe('Unknown ActionType', () => {
    it('should render with empty config when actionType is unknown', () => {
      ...
      expect(screen.getByRole('dialog')).toBeInTheDocument();
      expect(
        screen.queryByRole('button', { name: /supervisiona|rifiuta/i })
  ...
  describe('TextField Interactions', () => {
    ...
    it('should clear motivation when modal reopens', () => {
      const { rerender } = render(
        <ProductModal status={''} {...defaultProps} open={false} actionType="supervised" />
      );

      rerender(<ProductModal status={''} {...defaultProps} open={true} actionType="supervised" />);
  ...
  describe('API Calls Without onUpdateTable', () => {
    it('should handle supervised API call without onUpdateTable', async () => {
      const user = userEvent.setup();
      // @ts-ignore
      mockSetSupervisionedStatusList.mockResolvedValue(undefined);
