...
import { USERS_TYPES, PRODUCTS_STATES } from '../../../utils/constants';
...
jest.mock('../ProductModal', () => ({
  ...
  default: ({ open, onClose, onUpdateTable, onSuccess }: any) => {
    // Import dinamico per evitare errori di scope Jest
...
describe('ProductDataGrid', () => {
  ...
  // Altri test per batch actions, modali, messaggi di stato, edge case, ecc. possono essere aggiunti qui
});
