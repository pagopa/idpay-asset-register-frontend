...
describe('ProductStatusChip', () => {
  describe('quando status è undefined', () => {
    it('dovrebbe non renderizzare nulla', () => {
      const { container } = renderWithTheme(<ProductStatusChip status={undefined} />);
  ...
  describe('quando status è null (coercizione a undefined)', () => {
    it('dovrebbe non renderizzare nulla', () => {
      const { container } = renderWithTheme(<ProductStatusChip status={null as any} />);
      expect(container.firstChild).toBeNull();
    });
  });
  ...
  describe('quando status è una stringa vuota', () => {
    it('dovrebbe non renderizzare nulla', () => {
      const { container } = renderWithTheme(<ProductStatusChip status="" />);
      expect(container.firstChild).toBeNull();
    });
  });
  ...
  describe('quando status è "APPROVED"', () => {
    it('dovrebbe non renderizzare nulla', () => {
      const { container } = renderWithTheme(<ProductStatusChip status="APPROVED" />);
  ...
  describe('test di rendering completo', () => {
    ...
    it('dovrebbe renderizzare struttura corretta per status REJECTED', () => {
      const { container } = renderWithTheme(<ProductStatusChip status="REJECTED" />);
    ...
    it('dovrebbe renderizzare struttura corretta per status warning', () => {
      const { container } = renderWithTheme(<ProductStatusChip status="PENDING" />);
