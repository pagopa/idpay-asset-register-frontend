...
describe('ProductConfirmDialog', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders custom title and message', () => {
      render(<ProductConfirmDialog {...baseProps} title="Custom Title" message="Custom Message" />);
    ...
    it('handles empty title and message', () => {
      render(<ProductConfirmDialog {...baseProps} title="" message="" />);
      expect(screen.getByRole('dialog')).toBeInTheDocument();
      expect(screen.getByRole('button', { name: 'Cancel' })).toBeInTheDocument();
      expect(screen.getByRole('button', { name: 'Confirm' })).toBeInTheDocument();
    });
  ...
  describe('Complex Children', () => {
    ...
    it('handles undefined/null children', () => {
      const { rerender } = render(<ProductConfirmDialog {...baseProps} children={undefined} />);
      expect(screen.getByRole('dialog')).toBeInTheDocument();
