...
describe('ProductInfoRow', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long string value', () => {
      const longValue =
        'This is a very long value that might wrap to multiple lines and should still be rendered correctly without breaking the component layout or functionality';
